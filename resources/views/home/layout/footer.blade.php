        ...
        <div class="container">
                            ...
                            <ul class="small-posts">
                                ...
                                <li>
                                    ...
                                    <div class="post-cont">
                                        ...
                                        <ul class="post-tags">
                                            <li><i class="lnr lnr-user"></i>by <a href="index.html#">Besim Dauti</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
            ...
            <div class="down-footer">
                <ul class="list-footer">
                    ...
                    <li><a href="https://nunforest.com/minberi-mag/contact.html">Contact</a></li>
                </ul>
                <p>&copy; Copyright By Nunforest 2017<a href="index.html#" class="go-top"><i class="fa fa-caret-up"
