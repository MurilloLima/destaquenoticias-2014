                ...
                <ul class="slides">
                    <li>
                        <div class="news-post large-image-post">
                            <img src="{{ asset('home/upload/blog/lg1.jpg') }}" alt="">
                            <div class="hover-box">
                    ...
                    <li>
                        <div class="news-post large-image-post">
                            <img src="{{ asset('home/upload/blog/lg2.jpg') }}" alt="">
                            <div class="hover-box">
                                <a href="#" class="category category-world">World</a>
                                <h2><a href="single-post.html">More than one hundred thousand people evacuated in
                                        Indonesia</a></h2>
                                <ul class="post-tags">
                    ...
                    <li>
                        <div class="news-post large-image-post">
                            <img src="{{ asset('home/upload/blog/lg3.jpg') }}" alt="">
                            <div class="hover-box">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="news-post thumb-post">
                                            ...
                                            <h2><a href="single-post.html">Duis aute irure dolor in reprehenderit in
                                                    voluptate</a></h2>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="news-post thumb-post">
                                            ...
                                            <h2><a href="single-post.html">Excepteur sint occaecat cupidatat non
                                                    proident</a></h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                        <div class="news-post thumb-post">
                                            ...
                                            <h2><a href="single-post.html">Consectetur adipisicing elit, sed do eiusmod</a>
                                            </h2>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="news-post thumb-post">
                                            ...
                                            <h2><a href="single-post.html">Culpa qui officia deserunt mollit anim id
                                                    est</a></h2>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="sidebar theiaStickySidebar">
                        ...
                        <div class="widget social-widget">
                            ...
                            <ul class="social-share">
                                ...
                                <li>
                                    <a href="https://www.facebook.com/profile.php?id=100090408518901&paipv=0&eav=AfZvcACXtmgqpggpj9DwDfdYMDREmTUKrwzLna6m9-hydLz1hRmy5UdNBM5d8fk3nxQ"
                                        class="facebook">
                            ...
                            <ul class="small-posts">
                                <li>
                                    <a href="single-post.html">
                                        <img src="{{ asset('home/upload/blog/th1.jpg') }}" alt="">
                                    </a>
                                    <div class="post-cont">
                                        <h2><a href="single-post.html">New alternatives are more productive</a></h2>
                                        <ul class="post-tags">
                                ...
                                <li>
                                    <a href="single-post.html">
                                        <img src="{{ asset('home/upload/blog/th2.jpg') }}" alt="">
                                    </a>
                                    <div class="post-cont">
                                        <h2><a href="single-post.html">Vue js new javascript Framework</a></h2>
                                        <ul class="post-tags">
                        ...
                        <div class="widget tabs-widget">
                            <nav class="nav nav-tabs" id="myTab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-popular-tab" data-toggle="tab"
                                    href="index.html#nav-popular" role="tab" aria-controls="nav-popular"
                                    aria-selected="true">Popular</a>
                                <a class="nav-item nav-link" id="nav-recent-tab" data-toggle="tab"
                                    href="index.html#nav-recent" role="tab" aria-controls="nav-recent"
                                    aria-selected="false">Recent</a>
                                <a class="nav-item nav-link" id="nav-comments-tab" data-toggle="tab"
                                    href="index.html#nav-comments" role="tab" aria-controls="nav-comments"
                                    ...
                                    <ul class="small-posts">
                                        <li>
                                            ...
                                            <div class="post-cont">
                                                ...
                                                <ul class="post-tags">
                                                    <li><i class="lnr lnr-user"></i>by <a href="index.html#">Author</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div class="post-cont">
                                                <h2><a href="single-post.html">Vue js new javascript Framework</a></h2>
                                                <ul class="post-tags">
                                                    <li><i class="lnr lnr-user"></i>by <a href="index.html#">Besim
                                                            Dauti</a></li>
                                                </ul>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div class="post-cont">
                                                ...
                                                <ul class="post-tags">
                                                    <li><i class="lnr lnr-user"></i>by <a href="index.html#">Admin Mag</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div class="post-cont">
                                                <h2><a href="single-post.html">Visiting antic countries is John Doe
                                                        hobby.</a></h2>
                                                <ul class="post-tags">
                                                    <li><i class="lnr lnr-user"></i>by <a href="index.html#">Helena
                                                            Doe</a></li>
                                                </ul>
                                            </div>
                                        </li>
                                    ...
                                    <ul class="small-posts">
                                        ...
                                        <li>
                                            ...
                                            <div class="post-cont">
                                                ...
                                                <ul class="post-tags">
                                                    <li><i class="lnr lnr-user"></i>by <a href="index.html#">Admin
                                                            Mag</a></li>
                                                </ul>
                                            </div>
                                        </li>
